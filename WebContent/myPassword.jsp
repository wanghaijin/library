...
<form>
	...
	<form action="UpdatePasswordServlet" method="post">
		<table>
			<tr>
				<td>读者编号</td>
				<td><input type="text" name="rdId" value="${admin }" readonly="readonly"/></td>
			</tr>
			<tr>
				<td>新密码</td>
				<td><input type="text" name="rdPwd"/></td>
			</tr>
			<tr>
				<td><input type="hidden" name="passType" value="my"/></td>
				<td><input type="submit" value="更新密码"/></td>
			</tr>
			<tr>
				<c:if test="${myPassword!=null }">
					<c:out value="${myPassword }"></c:out>
					<c:remove  var="myPassword"  scope="session"  />					
				</c:if>
			</tr>
		</table>
	</form>
